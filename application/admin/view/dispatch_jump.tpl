...
<head>
    ...
    <title>跳转提示 | {:config('web_site_title')} - ruimeng898</title>
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <div class="push-50">
                ...
                <a class="btn btn-minw btn-rounded btn-default" href="{:url('admin/index/index')}"><i class="fa fa-home"></i> 返回首页</a>
            </div>
            <!-- END Error Titles -->
...
<div class="content pulldown text-muted text-center">
    极简 · 极速 · 极致<br>
    TPPHP，让开发更简单！<br>
    由 <a class="link-effect" href="http://www.ruimeng898.com">ruimeng898</a> 强力驱动 <a class="link-effect" href="http://www.ruimeng898.com">卓锐科技</a> 倾情奉献
</div>
<!-- END Error Footer -->
