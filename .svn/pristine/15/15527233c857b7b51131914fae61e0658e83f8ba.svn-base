...
class Admin extends Common
{
    ...
    protected function _initialize()
    {
        ...
        defined('ROLE') or define('ROLE', $user_auth['role']);
        // 检查权限
     ...
     * @param $val   值
     */
    protected function getOneArray($data,$key,$val){
      $oneArr = [];
      if(is_array($data)){
          foreach($data as $k=>$v){
     ...
     * ["nickname"] => string(15) "超级管理员"
     * ["last_login_time"] => int(1490236383)
     * ["last_login_ip"] => string(10) "2130706433"
     */
    protected function getAdmin(){
      if(isset($_SESSION['tp_admin_']['user_auth'])){
         return $_SESSION['tp_admin_']['user_auth'];
      }else{
          return false;
      }
    }
