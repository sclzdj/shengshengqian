...
class Request
{
    ...
    private $_is_plugins_module = false;
    ...
    /**
     * @return the $_is_plugins_module
     */
    public function getIs_plugins_module()
    {
        return $this->_is_plugins_module;
    }

 /**
     * @param boolean $_is_plugins_module
     */
    public function setIs_plugins_module($_is_plugins_module)
    {
        $this->_is_plugins_module = $_is_plugins_module;
    }
...
//         array(1) {
//             ["file"] => array(5) {
//                 ["name"] => string(22) "201506191506503395.png"
//                     ["type"] => string(9) "image/png"
//                         ["tmp_name"] => string(22) "C:\Windows\phpF472.tmp"
//                             ["error"] => int(0)
//                             ["size"] => int(53293)
//             }
//         }
