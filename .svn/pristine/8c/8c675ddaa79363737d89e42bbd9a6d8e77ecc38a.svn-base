...
CREATE TABLE `dp_admin_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='系统配置表';
...
INSERT INTO `dp_admin_config` VALUES ('2', 'web_site_title', '站点标题', 'base', 'text', 'TPPHP', '', '调用方式：<code>config(\'web_site_title\')</code>', '', '', '', '', '', '2', '', '', '', '', '1475240646', '1477710341', '2', '1');
INSERT INTO `dp_admin_config` VALUES ('3', 'web_site_slogan', '站点标语', 'base', 'text', 'TPPHP，极简、极速、极致', '', '站点口号，调用方式：<code>config(\'web_site_slogan\')</code>', '', '', '', '', '', '2', '', '', '', '', '1475240994', '1477710357', '3', '1');
...
INSERT INTO `dp_admin_config` VALUES ('6', 'web_site_keywords', '站点关键词', 'base', 'text', '后台框架', '', '网站搜索引擎关键字', '', '', '', '', '', '2', '', '', '', '', '1475241328', '1475241328', '7', '1');
INSERT INTO `dp_admin_config` VALUES ('7', 'web_site_copyright', '版权信息', 'base', 'text', 'Copyright © 2015-2016 ruimeng898 All rights reserved.', '', '调用方式：<code>config(\'web_site_copyright\')</code>', '', '', '', '', '', '2', '', '', '', '', '1475241416', '1477710383', '8', '1');
...
CREATE TABLE `dp_admin_hook_plugin` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='钩子-插件对应表';
...
INSERT INTO `dp_admin_menu` VALUES ('7', '5', 'admin', '配置管理', 'fa fa-fw fa-gears', 'module', 'admin/config/index', '_self', '0', '1467618618', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('8', '7', 'admin', '新增', '', 'module', 'admin/config/add', '_self', '0', '1467618648', '1477710695', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('9', '7', 'admin', '编辑', '', 'module', 'admin/config/edit', '_self', '0', '1467619566', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('10', '7', 'admin', '删除', '', 'module', 'admin/config/delete', '_self', '0', '1467619583', '1477710695', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('11', '7', 'admin', '启用', '', 'module', 'admin/config/enable', '_self', '0', '1467619609', '1477710695', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('12', '7', 'admin', '禁用', '', 'module', 'admin/config/disable', '_self', '0', '1467619637', '1477710695', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('13', '5', 'admin', '节点管理', 'fa fa-fw fa-bars', 'module', 'admin/menu/index', '_self', '0', '1467619882', '1477710695', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('14', '13', 'admin', '新增', '', 'module', 'admin/menu/add', '_self', '0', '1467619902', '1477710695', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('15', '13', 'admin', '编辑', '', 'module', 'admin/menu/edit', '_self', '0', '1467620331', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('16', '13', 'admin', '删除', '', 'module', 'admin/menu/delete', '_self', '0', '1467620363', '1477710695', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('17', '13', 'admin', '启用', '', 'module', 'admin/menu/enable', '_self', '0', '1467620386', '1477710695', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('18', '13', 'admin', '禁用', '', 'module', 'admin/menu/disable', '_self', '0', '1467620404', '1477710695', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('19', '68', 'user', '权限管理', 'fa fa-fw fa-key', 'module', '', '_self', '0', '1467688065', '1477710702', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('20', '19', 'user', '用户管理', 'fa fa-fw fa-user', 'module', 'user/index/index', '_self', '0', '1467688137', '1477710702', '1', '1', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('211', '64', 'admin', '日志详情', '', 'module', 'admin/log/details', '_self', '0', '1480299320', '1480299320', '100', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('32', '4', 'admin', '扩展中心', 'si si-social-dropbox', 'module', '', '_self', '0', '1467688853', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('33', '32', 'admin', '模块管理', 'fa fa-fw fa-th-large', 'module', 'admin/module/index', '_self', '0', '1467689008', '1477710695', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('34', '33', 'admin', '导入', '', 'module', 'admin/module/import', '_self', '0', '1467689153', '1477710695', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('35', '33', 'admin', '导出', '', 'module', 'admin/module/export', '_self', '0', '1467689173', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('36', '33', 'admin', '安装', '', 'module', 'admin/module/install', '_self', '0', '1467689192', '1477710695', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('37', '33', 'admin', '卸载', '', 'module', 'admin/module/uninstall', '_self', '0', '1467689241', '1477710695', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('38', '33', 'admin', '启用', '', 'module', 'admin/module/enable', '_self', '0', '1467689294', '1477710695', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('39', '33', 'admin', '禁用', '', 'module', 'admin/module/disable', '_self', '0', '1467689312', '1477710695', '6', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('40', '33', 'admin', '更新', '', 'module', 'admin/module/update', '_self', '0', '1467689341', '1477710695', '7', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('41', '32', 'admin', '插件管理', 'fa fa-fw fa-puzzle-piece', 'module', 'admin/plugin/index', '_self', '0', '1467689527', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('42', '41', 'admin', '导入', '', 'module', 'admin/plugin/import', '_self', '0', '1467689650', '1477710695', '1', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('43', '41', 'admin', '导出', '', 'module', 'admin/plugin/export', '_self', '0', '1467689665', '1477710695', '2', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('44', '41', 'admin', '安装', '', 'module', 'admin/plugin/install', '_self', '0', '1467689680', '1477710695', '3', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('45', '41', 'admin', '卸载', '', 'module', 'admin/plugin/uninstall', '_self', '0', '1467689700', '1477710695', '4', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('46', '41', 'admin', '启用', '', 'module', 'admin/plugin/enable', '_self', '0', '1467689730', '1477710695', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('47', '41', 'admin', '禁用', '', 'module', 'admin/plugin/disable', '_self', '0', '1467689747', '1477710695', '6', '1', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('55', '50', 'admin', '删除', '', 'module', 'admin/attachment/delete', '_self', '0', '1467690396', '1477710695', '5', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('56', '41', 'admin', '删除', '', 'module', 'admin/plugin/delete', '_self', '0', '1467858065', '1477710695', '11', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('57', '41', 'admin', '编辑', '', 'module', 'admin/plugin/edit', '_self', '0', '1467858092', '1477710695', '10', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('60', '41', 'admin', '新增', '', 'module', 'admin/plugin/add', '_self', '0', '1467858421', '1477710695', '9', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('61', '41', 'admin', '执行', '', 'module', 'admin/plugin/execute', '_self', '0', '1467879016', '1477710695', '14', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('62', '13', 'admin', '保存', '', 'module', 'admin/menu/save', '_self', '0', '1468073039', '1477710695', '6', '1', '1');
INSERT INTO `dp_admin_menu` VALUES ('64', '5', 'admin', '系统日志', 'fa fa-fw fa-book', 'module', 'admin/log/index', '_self', '0', '1476111944', '1477710695', '6', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('65', '5', 'admin', '数据库管理', 'fa fa-fw fa-database', 'module', 'admin/database/index', '_self', '0', '1476111992', '1477710695', '8', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('66', '32', 'admin', '数据包管理', 'fa fa-fw fa-database', 'module', 'admin/packet/index', '_self', '0', '1476112326', '1477710695', '4', '0', '1');
...
INSERT INTO `dp_admin_menu` VALUES ('77', '69', 'admin', '新增', '', 'module', 'admin/hook/add', '_self', '0', '1476668971', '1477710695', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('78', '69', 'admin', '编辑', '', 'module', 'admin/hook/edit', '_self', '0', '1476669006', '1477710695', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('79', '69', 'admin', '删除', '', 'module', 'admin/hook/delete', '_self', '0', '1476669375', '1477710695', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('80', '69', 'admin', '启用', '', 'module', 'admin/hook/enable', '_self', '0', '1476669427', '1477710695', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('81', '69', 'admin', '禁用', '', 'module', 'admin/hook/disable', '_self', '0', '1476669564', '1477710695', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('183', '66', 'admin', '安装', '', 'module', 'admin/packet/install', '_self', '0', '1476851362', '1477710695', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('184', '66', 'admin', '卸载', '', 'module', 'admin/packet/uninstall', '_self', '0', '1476851382', '1477710695', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('185', '5', 'admin', '行为管理', 'fa fa-fw fa-bug', 'module', 'admin/action/index', '_self', '0', '1476882441', '1477710695', '7', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('186', '185', 'admin', '新增', '', 'module', 'admin/action/add', '_self', '0', '1476884439', '1477710695', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('187', '185', 'admin', '编辑', '', 'module', 'admin/action/edit', '_self', '0', '1476884464', '1477710695', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('188', '185', 'admin', '启用', '', 'module', 'admin/action/enable', '_self', '0', '1476884493', '1477710695', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('189', '185', 'admin', '禁用', '', 'module', 'admin/action/disable', '_self', '0', '1476884534', '1477710695', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('190', '185', 'admin', '删除', '', 'module', 'admin/action/delete', '_self', '0', '1476884551', '1477710695', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('191', '65', 'admin', '备份数据库', '', 'module', 'admin/database/export', '_self', '0', '1476972746', '1477710695', '1', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('192', '65', 'admin', '还原数据库', '', 'module', 'admin/database/import', '_self', '0', '1476972772', '1477710695', '2', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('193', '65', 'admin', '优化表', '', 'module', 'admin/database/optimize', '_self', '0', '1476972800', '1477710695', '3', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('194', '65', 'admin', '修复表', '', 'module', 'admin/database/repair', '_self', '0', '1476972825', '1477710695', '4', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('195', '65', 'admin', '删除备份', '', 'module', 'admin/database/delete', '_self', '0', '1476973457', '1477710695', '5', '0', '1');
INSERT INTO `dp_admin_menu` VALUES ('210', '41', 'admin', '快速编辑', '', 'module', 'admin/plugin/quickedit', '_self', '0', '1477713981', '1477713981', '100', '0', '1');
...
CREATE TABLE `dp_admin_module` (
  ...
  `access` text NOT NULL COMMENT '授权配置',
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='模块表';

-- ----------------------------
-- Records of dp_admin_module
-- ----------------------------
INSERT INTO `dp_admin_module` VALUES ('1', 'admin', '系统', 'fa fa-fw fa-gear', '系统模块，核心模块', 'DolphinPHP', 'http://www.ruimeng898.com', '', '', '1.0.0', 'admin.dolphinphp.module', '1', '1468204902', '1468204902', '100', '1');
INSERT INTO `dp_admin_module` VALUES ('2', 'user', '用户', 'fa fa-fw fa-user', '用户模块，自带模块', 'DolphinPHP', 'http://www.ruimeng898.com', '', '', '1.0.0', 'user.dolphinphp.module', '1', '1468204902', '1468204902', '100', '1');
