...
class Index extends Admin
{
    ...
    public function index()
    {
        ...
        $btn_set = [
            ...
            'href'  => url('admin/agentconfig/setAgent', ['uid' => '__id__'])
        ];
...
//                ['role', '角色', 'select', RoleModel::getTree(null, false)],
                ['role', '角色', 'callback', function($roleId){
                    $role = Db::name('admin_role')->where('id = ?',[$roleId])->find();
            ...
            ->addRightButton('custom', $btn_set) // 添加授权按钮
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($user = UserModel::create($data)) {
                ...
                return $this->success('新增成功', url('admin/agentconfig/setAgent',['uid'=>$user['id']]));
            } else {
     ...
     * @return mixed
     */
    public function edit($id = null,$group='tab1')
    {
